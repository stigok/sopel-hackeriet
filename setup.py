...
setup(
    name='sopel_modules.hackeriet',
    version='0.0.1',
    description='sopel-hackeriet is a msopel module for Oslo Hackerspace',
    long_description=readme + '\n\n' + history,
    author='Paul Bergene',
    author_email='bezaban@hackeriet.no',
    url='https://github.com/bezaban/sopel-hackeriet',
